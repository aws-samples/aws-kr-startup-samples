...
class SageMakerInferenceComponentStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str,
    ...
    self.sagemaker_inference_component = aws_sagemaker.CfnInferenceComponent(self, "CfnInferenceComponent",
    ...
    cdk.CfnOutput(self, 'InferenceComponentName',
      value=self.sagemaker_inference_component.inference_component_name,
      export_name=f'{self.stack_name}-InferenceComponentName')
    cdk.CfnOutput(self, 'EndpointName',
      value=self.sagemaker_inference_component.endpoint_name,
