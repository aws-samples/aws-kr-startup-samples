...
$ git sparse-checkout set machine-learning/sagemaker/whisper-model-hosting-on-sagemaker-endpoint/sagemaker-async-inference/hugging-face
$ cd machine-learning/sagemaker/whisper-model-hosting-on-sagemaker-endpoint/sagemaker-async-inference/hugging-face
