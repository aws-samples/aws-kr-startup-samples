...
$ git sparse-checkout set machine-learning/sagemaker/whisper-model-hosting-on-sagemaker-endpoint/sagemaker-async-inference/jumpstart
$ cd machine-learning/sagemaker/whisper-model-hosting-on-sagemaker-endpoint/sagemaker-async-inference/jumpstart
