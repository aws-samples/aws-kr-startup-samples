...
class MilvusRAG:
    ...
    def create_or_recreate_knowledge_base(self):
        ...
        fields = [
            ...
            FieldSchema(name="embedding", dtype=DataType.FLOAT_VECTOR, dim=RAG_VECTOR_DIM),
            FieldSchema(name="text", dtype=DataType.VARCHAR, max_length=RAG_MAX_TEXT_LENGTH),
            FieldSchema(name="source", dtype=DataType.VARCHAR, max_length=RAG_MAX_SOURCE_LENGTH)
        ]
