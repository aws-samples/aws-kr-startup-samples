...
import claude_chat_with_bedrock_knowledge_base as llm_app
...
def handle_input():
  ...
  if 'context' in result:
    for d in result['context']:
      citation = d.metadata['source_metadata']['x-amz-bedrock-kb-source-uri']
      if citation not in document_list:
