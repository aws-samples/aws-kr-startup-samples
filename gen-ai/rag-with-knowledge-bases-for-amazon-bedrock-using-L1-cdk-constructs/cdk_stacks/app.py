...
vpc_stack = VpcStack(app, 'RAGwithKBVpcStack',
  env=AWS_ENV)
vpc_stack.add_dependency(kb_data_source_stack)

sm_studio_stack = SageMakerStudioStack(app, 'RAGwithKBSageMakerStudioStack',
  vpc_stack.vpc,
  env=AWS_ENV)
