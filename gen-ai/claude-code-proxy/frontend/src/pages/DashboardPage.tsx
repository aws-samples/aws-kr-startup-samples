...
export default function DashboardPage() {
  ...
  const [expandedChart, setExpandedChart] = useState<
    'token' | 'cost' | 'requests' | 'topUserUsage' | 'modelMix' | null
  >(null);
  ...
  useEffect(() => {
    ...
    Promise.all([
      api.getUsage(usageParams),
      api.getTopUsers(topUsersParams),
      api.getTopUserSeries(topUsersParams),
    ])
      .then(([usageResponse, topUsersResponse, topUserSeriesResponse]) => {
        if (!active) return;
        ...
        <section className="space-y-3">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-line bg-surface p-6 shadow-soft">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  <h3 className="text-base font-semibold text-ink">Token Usage</h3>
            ...
            <div className="rounded-2xl border border-line bg-surface p-6 shadow-soft">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  <h3 className="text-base font-semibold text-ink">Cost Burn</h3>
        ...
        <section className="space-y-3">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-line bg-surface p-6 shadow-soft">
              ...
              <div className="mt-6">{renderTopUserUsageChart('h-72')}</div>
            </div>
          </div>
        </section>
      )}
          ...
          >
            <div className="flex items-center justify-between">
              <div className="text-lg font-semibold text-ink">
                {expandedChart === 'token' && 'Token Usage'}
                {expandedChart === 'cost' && 'Cost Burn'}
