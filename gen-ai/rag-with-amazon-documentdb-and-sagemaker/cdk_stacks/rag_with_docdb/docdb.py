...
class DocumentDBStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, vpc, **kwargs) -> None:
    ...
    sg_docdb_client = aws_ec2.SecurityGroup(self, 'DocDBClientSG',
      ...
      security_group_name=f'docdb-client-sg-{docdb_cluster_name.lower()}'
    )
    ...
    sg_docdb_server = aws_ec2.SecurityGroup(self, 'DocDBServerSG',
      ...
      security_group_name=f'docdb-server-sg-{docdb_cluster_name.lower()}'
    )
    ...
    cdk.CfnOutput(self, 'DocDBSecret',
