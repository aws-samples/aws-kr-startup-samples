...
class SageMakerStudioStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, vpc, **kwargs) -> None:
    ...
    sm_studio_domain_name = self.node.try_get_context('sagemaker_studio_domain_name') or 'rag-with-kendra-workshop'
    ...
    self.sm_execution_role = sagemaker_execution_role
