  ...
  def __init__(self, scope: Construct, id: str, vpc, **kwargs) -> None:
    ...
    rds_cluster_param_group = aws_rds.ParameterGroup(self, 'AuroraMySQLClusterParamGroup',
      ...
      parameters={
        ...
        #XXX: Setting up enhanced binlog for Aurora MySQL
        # https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Enhanced.binlog.html
        ...
        #XXX: make sure that the `binlog_row_value_options` parameter is not set to `PARTIAL_JSON`
        # 'binlog_row_value_options': '',
        #XXX: If the source database is a Multi-AZ DB cluster, make sure that the `binlog_transaction_compression` parameter is not set to `ON`
