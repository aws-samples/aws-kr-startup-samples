...
class MysqlStack(Stack):
  ...
  def __init__(self, scope: Construct, id: str, vpc, **kwargs) -> None:
    ...
    db_instance_name = self.node.try_get_context('rds_instance_name')
    ...
    rds_param_group = aws_rds.ParameterGroup(self, 'MySQLDBParamGroup',
      ...
      parameters={
        ...
        #XXX: Setting up enhanced binlog for MySQL
    ...
    self.rds_instance = replica_instance


    cdk.CfnOutput(self, 'RDSZeroETLSourceArn',
      value=self.rds_instance.instance_arn,
      export_name=f'{self.stack_name}-RDSZeroETLSourceArn')
